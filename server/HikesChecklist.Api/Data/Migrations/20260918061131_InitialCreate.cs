        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SourceModifiedAt = table.Column<DateTime>(type: "TEXT", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    VisitedOn = table.Column<DateOnly>(type: "TEXT", nullable: false),
                    Notes = table.Column<string>(type: "TEXT", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "TEXT", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_VisitedPeaks", x => x.Id);
                    table.ForeignKey(
                        name: "FK_VisitedPeaks_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_VisitedPeaks_Peaks_PeakId",
                        column: x => x.PeakId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_VisitedPeaks_PeakId",
                table: "VisitedPeaks",
                column: "PeakId");

            migrationBuilder.CreateIndex(
                name: "IX_VisitedPeaks_UserId_PeakId",
                table: "VisitedPeaks",
