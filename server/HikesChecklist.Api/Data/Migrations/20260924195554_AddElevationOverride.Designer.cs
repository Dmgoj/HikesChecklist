...
namespace HikesChecklist.Api.Data.Migrations
{
    ...
    [Migration("20260924195554_AddElevationOverride")]
    partial class AddElevationOverride
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HikesChecklist.Api.Models.BucketListEntry", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("HikesChecklist.Api.Models.BucketListEntry", b =>
                {
                    b.HasOne("HikesChecklist.Api.Models.Peak", "Peak")
                        .WithMany("BucketListedByUsers")
                        .HasForeignKey("PeakId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("HikesChecklist.Api.Models.ApplicationUser", "User")
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("HikesChecklist.Api.Models.ApplicationUser", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
